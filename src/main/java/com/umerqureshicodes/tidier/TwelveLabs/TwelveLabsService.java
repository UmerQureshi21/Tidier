...
public class TwelveLabsService {
    ...
    public TwelveLabsTimeStampResponse getIntervalsOfTopic(String videoId, String topic) {
        // Serialized with Jackson so quotes or backslashes in the topic can't break the JSON
        String requestBody;
        try {
            ...
            System.out.println("Error in 12Labs Service's getIntervalsOfTopic method: " + e.getMessage());
            return null;
        }
